#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/155a0000.ufs/by-name/RECOVERY:46027040:351f481c8b60488202bb0d0232b686aa3dc12978; then
  applypatch EMMC:/dev/block/platform/155a0000.ufs/by-name/BOOT:38410528:f7946cc3c771b3ba911d4883c53375cc9f3c58b2 EMMC:/dev/block/platform/155a0000.ufs/by-name/RECOVERY 351f481c8b60488202bb0d0232b686aa3dc12978 46027040 f7946cc3c771b3ba911d4883c53375cc9f3c58b2:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
